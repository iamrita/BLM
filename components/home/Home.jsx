        ...
        <ul className="container">
          <li> 
            <button className="panel"
             ...
             {!this.state.isShown0 ? 
              <div className="topleft">places to donate</div> 
            :
              <ul className="list">
          ...
          <li>
            <button className="panel"
              ...
              onMouseLeave={() => this.setIsShown1()}>
                 {!this.state.isShown1 ?     
                  <div className="topleft">protests near me</div> 
                 :
                   <ul className="list">
          ...
          <li> 
            <button className="panel"
              ...
              {!this.state.isShown2 ? 
                <div className="topleft">reading material</div> 
              :
                <ul className="list">
          ...
          <li>
            <button className="panel"
              ...
              {!this.state.isShown3 ? 
                <div className="topleft">voting info</div> 
              :
                <ul className="list">
          ...
          <li>
            <button className="panel"
              ...
              {!this.state.isShown5 ? 
                <div className="topleft">topics to discuss</div> 
              :
                <ul className="list">
